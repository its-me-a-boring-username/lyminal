...
export function MagicLinkAuth({ context, isLoggedIn = false, session = null, onSkip, onSuccess, leftOffset = 0 }) {
  ...
  const handleUpgrade = async () => {
    ...
    setError(null);
    try {
      const data = await postJson("/api/billing/create-checkout-session", {}, session);
          ...
          {!sent ? (
            ...
            <div style={{ textAlign: "center", padding: "1rem 0" }}>
              <div style={{ width: "48px", height: "48px", borderRadius: "50%", background: "#4a7a72", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.25rem" }}>
                <span style={{ color: "white", fontSize: "1.25rem" }}>OK</span>
              </div>
