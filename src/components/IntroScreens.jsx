      ...
      <div style={{ maxWidth: "480px" }} className="w-full">
        <div className="flex justify-center mb-6">
          <svg width="100" height="80" viewBox="0 0 100 80" fill="none">
            <line x1="25" y1="30" x2="50" y2="50" stroke="var(--ly-accent)" strokeWidth="1.5" opacity="0.4"/>
            <line x1="50" y1="50" x2="75" y2="25" stroke="var(--ly-accent)" strokeWidth="1.5" opacity="0.4"/>
            <line x1="25" y1="30" x2="75" y2="25" stroke="var(--ly-accent)" strokeWidth="1.5" opacity="0.25"/>
            <line x1="50" y1="50" x2="60" y2="65" stroke="var(--ly-accent)" strokeWidth="1.5" opacity="0.3"/>
        ...
        <p className="text-xs uppercase tracking-widest mb-3 font-medium" style={{ color: "var(--ly-accent)", letterSpacing: "0.12em" }}>Step 3 of 3</p>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", fontWeight: 600, color: "#1c1410", lineHeight: 1.3 }} className="mb-4">
          Map the <em style={{ color: "var(--ly-accent)" }}>influence</em>
        </h2>
        <p className="text-sm leading-relaxed mb-3" style={{ color: "#4a3828", fontWeight: 300 }}>
        ...
        {primaryBtn(() => setStep("connections"), "MAP CONNECTIONS →", "var(--ly-accent)")}
  ...
  if (screen === "intro-results") return (
    <div {...base}>
      ...
      <div style={{ maxWidth: "480px" }} className="w-full">
        <div className="flex justify-center mb-6">
          <svg width="100" height="80" viewBox="0 0 100 80" fill="none">
            <rect x="15" y="40" width="12" height="30" rx="2" fill="var(--ly-accent)" opacity="0.3"/>
            <rect x="33" y="25" width="12" height="45" rx="2" fill="var(--ly-accent)" opacity="0.45"/>
            <rect x="51" y="10" width="12" height="60" rx="2" fill="var(--ly-accent)" opacity="0.6"/>
            <rect x="69" y="30" width="12" height="40" rx="2" fill="var(--ly-accent)" opacity="0.4"/>
            <circle cx="57" cy="10" r="5" fill="var(--ly-accent)" opacity="0.7"/>
          </svg>
        </div>
        <p className="text-xs uppercase tracking-widest mb-3 font-medium" style={{ color: "var(--ly-accent)", letterSpacing: "0.12em" }}>You're done!</p>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.8rem", fontWeight: 600, color: "#1c1410", lineHeight: 1.3 }} className="mb-4">
          Your <em style={{ color: "var(--ly-accent)" }}>goal chart</em> is ready
        </h2>
        <p className="text-sm leading-relaxed mb-3" style={{ color: "#4a3828", fontWeight: 300 }}>
        ...
        {primaryBtn(() => { saveChart(session, { spheres, connections }); setStep("chart"); }, "SEE MY CHART →", "var(--ly-accent)")}
